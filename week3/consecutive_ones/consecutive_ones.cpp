//consecutive ones: famous problem solved by PQ tree, but this seems too complicated to implement --> try exhautive search
...
{
  //swap two collumns in the matrix
  REP(i, nbRows)
    swap(mat[i][colI], mat[i][colJ]);

  //swap the index of these two collumns to keep track
